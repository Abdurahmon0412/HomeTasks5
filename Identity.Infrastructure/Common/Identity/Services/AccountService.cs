...
public class AccountService
{
    ...
    public AccountService(IVerificationTokenGeneratorService verificationTokenGeneratorService,
        IEmailOrchestrationService emailOrchestrationService, IUserService userService)
    {
    ...
    public ValueTask<bool> VerificateAsync(string token, CancellationToken cancellationToken = default)
    {
        ...
        var verificationTokenResult = _verificationTokenGeneratorService.DecadeToken(token);

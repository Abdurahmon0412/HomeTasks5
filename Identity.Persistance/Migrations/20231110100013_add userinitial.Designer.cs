...
namespace Identity.Persistance.Migrations
{
    ...
    [Migration("20231110100013_add userinitial")]
            ...
            modelBuilder.Entity("Identity.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 11, 10, 10, 0, 13, 560, DateTimeKind.Utc).AddTicks(5904),
                            IsDisabled = false,
                            Type = 2,
                        ...
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 11, 10, 10, 0, 13, 560, DateTimeKind.Utc).AddTicks(5907),
                            IsDisabled = false,
                            Type = 0,
                            UpdatedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 11, 10, 10, 0, 13, 560, DateTimeKind.Utc).AddTicks(5909),
                            IsDisabled = false,
                            Type = 1,
                            UpdatedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
            ...
            modelBuilder.Entity("Identity.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("09c95277-b051-4196-8dcf-6c6d66da1bd2"),
                            Age = 39,

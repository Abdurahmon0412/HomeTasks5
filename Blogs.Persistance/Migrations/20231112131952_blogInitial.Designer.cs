...
namespace Blogs.Persistance.Migrations
{
    ...
    [Migration("20231112131952_blogInitial")]
    partial class blogInitial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Blogs.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 11, 12, 13, 19, 52, 119, DateTimeKind.Utc).AddTicks(9609),
                            IsDesabled = false,
                            Type = 1,
                        ...
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 11, 12, 13, 19, 52, 119, DateTimeKind.Utc).AddTicks(9616),
                            IsDesabled = false,
                            Type = 0,
                            UpdatedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
            ...
            modelBuilder.Entity("Blogs.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f9365115-ba56-4a75-a8d9-ff291ddd0478"),
                            Age = 20,
